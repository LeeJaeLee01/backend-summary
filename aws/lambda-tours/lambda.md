...
> Khái niệm cốt lõi (SAA): [`concept.md`](./concept.md) · Problems hay gặp: [`problems.md`](./problems.md) · **DB connections:** [`db-connections.md`](./db-connections.md) · Trigger: [`sqs.md`](./sqs.md) · [`sns.md`](./sns.md) · [`eventbridge.md`](./eventbridge.md) · [`s3-trigger.md`](./s3-trigger.md) · Scale: [`cold-start-scale.md`](./cold-start-scale.md)
...
□ Dùng RDS Proxy giảm connection storm — xem [`db-connections.md`](./db-connections.md)
```
...
| File | Nội dung |
|------|----------|
| [concept.md](./concept.md) | Khái niệm cốt lõi — invocation, concurrency, VPC, limits (SAA) |
| [sqs.md](./sqs.md) | SQS event source mapping, partial batch failure |
| [sns.md](./sns.md) | SNS fan-out → Lambda |
| [eventbridge.md](./eventbridge.md) | Cron schedule, event bus routing |
| [s3-trigger.md](./s3-trigger.md) | S3 upload → Lambda xử lý file |
| [ecr.md](./ecr.md) | Container image Lambda (alternative to zip) |
| [db-connections.md](./db-connections.md) | Nhiều Lambda/serverless kết nối 1 DB — connection storm, RDS Proxy |
| [cold-start-scale.md](./cold-start-scale.md) | Cold start, throttling, RDS Proxy |
| [../sqs.md](../sqs.md) | SQS queue tổng quát (visibility, DLQ, FIFO) |
